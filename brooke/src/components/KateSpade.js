...
const KateSpade = () =>
  <div className="kate-content">
    <h3 className="role">Assistant General Manager, Operations</h3>
    <h3 className="when">>Madison Avenue Flagship March 2016 - February 2017</h3>
    <p className="duties">
      ...
      <br /><br />- Led a large operations team; was responsible for hiring of, development and training. Planned logistics of their workload, including a large e-commerce department
      <br /><br />- Assisted in scheduling for the flagship, analyzed payroll needs based on work flow, and P&L
      <br /><br />- Responsible for all in-store inventory control & loss prevention, including audits, training and coaching. Partnered with corporate PR team on all inventory pulls, and product sourcing
    </p>
    <br />
    <h3 className="role">Sales Manager</h3>
    <h3 className="when">Madison Avenue Flagship March 2015 - March 2016</h3>
    <p className="duties">
      <br />- Developed a new system of sales management; including staff accountability & mentorship strategy, custom sales tools, and an entirely new suite of Excel-based programs for sales tracking, analysis & re-forecasting. As a result, increased client sales by 35%, exceeding my annual goal by 15 points. Said system, programs & tools are now being implemented company-wide, taught by the national training team
